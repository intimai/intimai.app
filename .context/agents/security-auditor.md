...
- [`encrypt`](handle-webhook-corrected.ts#L13) (function)
- [`decrypt`](handle-webhook-corrected.ts#L52) (function)
- [`encryptSensitiveData`](handle-webhook-corrected.ts#L97) (function)
- [`decryptSensitiveData`](handle-webhook-corrected.ts#L114) (function)
- [`encrypt`](supabase\functions\handle-webhook\index.ts#L11) (function)
- [`decrypt`](supabase\functions\handle-webhook\index.ts#L41) (function)
- [`encryptSensitiveData`](supabase\functions\handle-webhook\index.ts#L74) (function)
- [`decryptSensitiveData`](supabase\functions\handle-webhook\index.ts#L92) (function)
- [`decrypt`](supabase\functions\get-decrypted-intimacao-details\index.ts#L5) (function)
- [`encrypt`](supabase\functions\encrypt-existing-data\index.ts#L11) (function)
- [`encryptField`](supabase\functions\create-intimacao-with-check\index.ts#L37) (function)
...
- [`encrypt`](src\lib\encryptionService.js#L57) (function)
- [`decrypt`](src\lib\encryptionService.js#L97) (function)
