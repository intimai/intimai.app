...
## Repository map
- `ANALISE_TECNICA.md/` — explain what lives here and when agents should edit it.
- `backup_supabase_guide.md/` — explain what lives here and when agents should edit it.
- `configurar_email_confirmacao.sql/` — explain what lives here and when agents should edit it.
- `configurar_templates_email_supabase.sql/` — explain what lives here and when agents should edit it.
- `consulta_duplicada_edgeFunction.ts/` — explain what lives here and when agents should edit it.
- `criar_tabela_email_templates.sql/` — explain what lives here and when agents should edit it.
- `CRIPTOGRAFIA_SETUP.md/` — explain what lives here and when agents should edit it.
- `dev-dist/` — explain what lives here and when agents should edit it.
